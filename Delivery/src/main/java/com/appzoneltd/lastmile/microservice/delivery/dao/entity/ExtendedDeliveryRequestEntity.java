...
@NamedQueries({
        @NamedQuery(name = "ExtendedDeliveryRequestEntity.countAll", query = "SELECT COUNT(x) FROM ExtendedDeliveryRequestEntity x")
})
public class ExtendedDeliveryRequestEntity implements Serializable {
