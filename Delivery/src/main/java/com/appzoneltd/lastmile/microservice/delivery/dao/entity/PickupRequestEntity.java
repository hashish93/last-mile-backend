...
public class PickupRequestEntity implements Serializable {
    ...
    private PickupRequestTypeEntity pickupRequestTypeEntity;
    ...
    public PickupRequestTypeEntity getPickupRequestTypeEntity() {
        return pickupRequestTypeEntity;
    }

    public void setPickupRequestTypeEntity(PickupRequestTypeEntity pickupRequestTypeEntity) {
        this.pickupRequestTypeEntity = pickupRequestTypeEntity;
    }
}
