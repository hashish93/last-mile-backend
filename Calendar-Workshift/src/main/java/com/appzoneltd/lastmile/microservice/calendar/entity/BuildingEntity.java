...
public class BuildingEntity implements Serializable {
	...
	@OneToMany(mappedBy = "building", targetEntity = HubCalendarEntity.class)
	private List<HubCalendarEntity> hubCalendars;

	@OneToMany(mappedBy = "building", targetEntity = WorkShiftEntity.class)
