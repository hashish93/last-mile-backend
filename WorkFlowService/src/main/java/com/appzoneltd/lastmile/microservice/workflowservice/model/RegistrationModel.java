...
public class RegistrationModel implements Serializable {
	...
	public RegistrationModel(Long _ID, Long vehicleId, Long hubId, Long deviceId, String vehicleStatus,
			...
			Long workShiftFrom, Long workShiftTo) {
		super();
		this._ID = _ID;
	...
	public String toString() {
		return "RegistrationModel [_ID=" + _ID + ", vehicleId=" + vehicleId + ", hubId=" + hubId + ", deviceId="
				+ deviceId + ", vehicleStatus=" + vehicleStatus + ", location=" + location + ", driverId=" + driverId
				+ ", driverName=" + driverName + ", driverNumber=" + driverNumber + ", rating=" + rating
				+ ", firebaseToken=" + firebaseToken + ", purpose=" + purpose + ", capacity=" + capacity
				+ ", jobOrders=" + jobOrders + ", _class=" + _class + ", workShiftId=" + workShiftId
				+ ", workShiftFrom=" + workShiftFrom + ", workShiftTo=" + workShiftTo + "]";
	}
