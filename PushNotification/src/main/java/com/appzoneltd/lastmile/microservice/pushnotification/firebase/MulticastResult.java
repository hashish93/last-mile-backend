...
public final class MulticastResult implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5310317584133548913L;
	...
	public String toString() {
		StringBuilder builder = new StringBuilder("MulticastResult(").append("multicast_id=").append(multicastId)
