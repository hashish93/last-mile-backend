...
import com.appzoneltd.lastmile.microservices.stats.service.pojo.MyPrincipal;
...
public class PrincipalService {
	...
	public boolean isFreelancerAdmin(Principal principal){
		try {
			MyPrincipal myPrincipal = objectMapper.readValue(principal.getName(),MyPrincipal.class);
			String userType=myPrincipal.getUserType();
			if("FREELANCER_ADMIN".equals(userType)){
				return true;
			}
		} catch (Exception e) {
			e.printStackTrace();
