...
@Component
public class DriverArrivedToCustomerConsumer{
	@Autowired
	...
	public void receiveMessage(@Payload String payload) throws JsonParseException, JsonMappingException, IOException {
		...
		System.out.println(">>>>>>>>>>>>>>>>>>>>>> preparing to driver arrived");
		runTimeService.startProcessInstanceByMessage("startDriverArrivedMessage", workflowData);
	}
}
