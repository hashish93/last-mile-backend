...
import com.appzoneltd.lastmile.microservice.returnworkflow.notification.model.NotificationLabel;
import com.appzoneltd.lastmile.microservice.returnworkflow.notification.model.NotificationModel;
...
public class PushNotificationService {
	...
	private void sendPushNotification(NotificationModel notificationModel) {
		try {
			returnWorkFlowProducer.sendMessage("push-notification",
