...
public class ActivitiConfig {
	...
	public SpringProcessEngineConfiguration processEngineConfiguration(
		...
		resources[0] = new ClassPathResource("/processes/OnDemandWorkflow.bpmn");
		resources[1] = new ClassPathResource("/processes/ScheduledWorkflow.bpmn");
		processEngineConfiguration.setDeploymentResources(resources);
		processEngineConfiguration.setProcessEngineName("LastMile_WF_OnDemand_Engine");
