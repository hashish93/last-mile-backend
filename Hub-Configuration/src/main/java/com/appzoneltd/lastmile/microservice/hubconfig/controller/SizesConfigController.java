...
import com.appzoneltd.lastmile.microservice.hubconfig.service.SizesConfigService;
import com.appzoneltd.lastmile.microservice.modelobjects.Message;

@RestController
@RequestMapping("/sizeConfig")
public class SizesConfigController {
	...
	public ResponseEntity<?> deleteSizesConfigById(@RequestBody SizesConfigDto sizesConfigDto) {
		...
		SizesConfigEntity deactivateConfig = sizeConfigService.deleteSizesConfig(sizesConfigDto);
