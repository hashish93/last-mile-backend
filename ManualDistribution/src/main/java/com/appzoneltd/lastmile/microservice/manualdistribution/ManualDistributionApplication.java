package com.appzoneltd.lastmile.microservice.manualdistribution;
...
@RibbonClient(name = "ManualDistributionApplication", configuration = RibbonConfiguration.class)
@EnableKafka
@EnableAsync
public class ManualDistributionApplication extends CoreApplicationConfig {

    @Value("${kafka.bootstrap.servers}")
    private String BOOTSTRAP_SERVERS;

    public static void main(String[] args) {
        SpringApplication.run(ManualDistributionApplication.class, args);
    }
